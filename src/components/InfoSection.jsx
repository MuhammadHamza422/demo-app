    ...
    <div className="relative w-[1180px] border-t border-[#E5E5E5] mt-40 ml-[130px]">
      ...
      <div className="mt-8 w-[1180px] h-[605px] bg-[#DF96AE] rounded-[20px] flex flex-col justify-between">
        <div className="flex items-start gap-8 px-16 pt-15">
          {/* Image */}
          <img src="/assets/InfoImage1.svg" alt="Card Image" className="w-[80px] h-[80px] object-contain cursor-pointer" />
        ...
        <div className="w-full">
          <img src="/assets/InfoImage2.svg" alt="Card" className="w-full h-auto object-contain rounded-[12px]" />
        </div>
      </div>
      ...
      <div className="flex gap-5 mt-5">
        ...
        <div className="w-[580px] h-[632px] bg-[#F4F0E4] rounded-[20px] flex flex-col">
          {/* Top Image */}
          <img src="/assets/card1Image.svg" alt="Card 1 Image" className="w-full h-[400px] object-cover rounded-t-[20px]" />

          {/* Icon + Heading + Text */}
          <div className="flex flex-col px-14 pb-6 space-y-4">
            <img src="/assets/card1Icon.svg" alt="Card 1 Icon" className="w-[80px] h-[80px]" />
        ...
        <div className="w-[580px] h-[633px] bg-[#384C75] rounded-[20px] flex flex-col pt-10">
          <div className="flex flex-col px-12 py-6 space-y-4 mt-auto">
            <img src="/assets/card2Icon.svg" alt="Card 2 Icon" className="w-[68px] h-[68px]" />
          ...
          {/* Bottom Image */}
          <img src="/assets/card2Image.svg" alt="Card 2 Image" className="w-full h-[400px] object-cover rounded-b-[20px] mt-5 pt-2" />
        </div>
      </div>

      {/* Centered Heading with Arrow */}
      <div className="flex items-center justify-center gap-3 py-20">
        <img src="/assets/arrow.svg" alt="Arrow Icon" className="w-[27px] h-[21px] pt-[2px] pr-[2.31px] pb-[2px] pl-[2px] rotate-0" />
